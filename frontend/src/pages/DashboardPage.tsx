        ...
        <div className="space-y-6 w-full max-w-4xl mx-auto">
                ...
                <Card className="bg-white border border-zinc-200/80 shadow-none rounded-lg">
                    <CardContent className="p-4 flex items-center gap-3.5">
                        ...
                        <div>
                            ...
                            <h3 className="text-xl font-bold text-zinc-900">0</h3>
                        </div>
                    </CardContent>
                </Card>
            ...
            <Card className="bg-zinc-50/50 border-dashed border-zinc-200 border-2 shadow-none rounded-lg">
                <CardContent className="p-8 text-center space-y-4 flex flex-col items-center">
                    ...
                    <Button className="bg-zinc-900 hover:bg-zinc-800 text-white text-xs font-semibold px-4 py-2 h-9 rounded-md shadow-sm">
